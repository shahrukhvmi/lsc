      ...
      {isLoading ? (
        ...
        <>
          <header className="pb-9">
            ...
            We offer the following weight loss injections treatment options to help you in your weight loss journey. You can request weight loss injections online at London Slimming Clinic. All treatment options are subject to approval by our UK-registered prescribers following the completion and assessment of the medical consultation form. View the weight loss treatment options below for more information. </p>
          </header>
